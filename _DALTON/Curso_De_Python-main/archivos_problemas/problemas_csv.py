...
df = pd.read_csv("_DALTON\\Curso_De_Python-main\\archivos_problemas\\datos.csv")
...
df['apellido'].replace("dalto","ramirez",inplace=True)
...
df.to_csv("_DALTON\\Curso_De_Python-main\\archivos_problemas\\datos_limpios.csv")
